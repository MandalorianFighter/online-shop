...
Route::group(['prefix' => 'admin', 'middleware' => ['auth:admin'], 'namespace' => '\App\Http\Controllers\Admin'], function () {   
    ...
    Route::get('/admin/password', '\AdminProfileController@changePass')->name('admin.password.change');
    Route::post('/admin/password/update', '\AdminProfileController@updatePass')->name('admin.password.update');

    // Admin Profile

    Route::get('/admin/profile', '\AdminProfileController@show')->name('admin.profile.show');
    Route::post('/admin/profile/update', '\AdminProfileController@adminUpdateProfile')->name('update.admin.profile');
