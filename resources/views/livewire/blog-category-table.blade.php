<div class="card pd-20 pd-sm-40">
    <h6 class="card-body-title">{{ __('Blog Category List') }}
    ...
    <table class="table display responsive nowrap">
        ...
        <tr>
            ...
            <td>
            <div class="d-flex align-items-center justify-content-center">
            <a href="{{ route('blog-categories.edit', $category) }}" class="btn btn-sm btn-info mr-2">{{ __('Edit') }}</a>
        ...
        @empty
        <tr>      
          <td colspan="3" class="empty-table">{{ __('No Blog Categories Found.') }}</td>
        </tr>
        @endforelse
        </tbody>
    </table>
          ...
          <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content tx-size-sm">
              <div class="modal-header pd-x-20">
                <h6 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold">{{ __('Delete Blog Category') }}</h6>
    ...
    <div id="modalCreate" class="modal fade">
          <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content tx-size-sm">
              <div class="modal-header pd-x-20">
                <h6 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold">{{ __('Add Blog Category') }}</h6>
                <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>
