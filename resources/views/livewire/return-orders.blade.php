<div class="card pd-20 pd-sm-40">
    ...
    <table class="table display responsive nowrap">
        ...
        <tr>
            ...
            <th class="wd-10p">
                <div class="d-flex align-items-center justify-content-start">
                    <button wire:click="sortBy('status')" class="btn btn-sm text-nowrap text-uppercase font-weight-bold p-0 border-0">{{ __('Return') }}</button>
        ...
        <tr>
            ...
            <td>
            <div class="d-flex align-items-center justify-content-center">
            <a href="{{ route('admin.return_approve', $order) }}" class="btn btn-sm btn-info mr-2">{{ __('Approve') }}</a>
            </div>
            </td>
        </tr>
        @empty
